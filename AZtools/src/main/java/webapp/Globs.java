...
public class Globs {
    ...
    private static final String basic_java = "C:/Ankur/Code/AZtools/AZtools/src/main/java/extraction/";
    private static final String agency_path = "C:/Ankur/Code/AZtools/AZtools/lib/agency_names.txt";
    private static final String serializedClassifier = "C:/Ankur/Code//AZtools/AZtools/lib/stanford-ner-2017-06-09/classifiers/english.conll.4class.distsim.crf.ser.gz";
    ...
    private static final String smtp_properties = "C:/Ankur/Code/AZtools/AZtools/src/main/resources/smtp.properties";
    private static final String json_response_path = "C:/Ankur/Code/AZtools/response.json";

    private static final String EMAIL_ADDRESS = "aztools.nih@gmail.com";
    private static final String EMAIL_PASSWORD = "e3jFMasd384";

    private static final String CACHED_TREE_MAP = "C:/Ankur/Code/AZtools/AZtools/src/main/java/extraction/funding/cached_tree_map.json";
